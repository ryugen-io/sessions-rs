#!/usr/bin/env python3
"""
README Generator for sessions-rs - Generates a tree view of the codebase
"""
...
def main():
    """Main function."""
    print()
    print(f"{Colors.MAUVE}[readme]{Colors.NC} {Icons.FILE}  generating tree...")
    print()
